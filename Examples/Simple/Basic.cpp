...
{
	PolyHedra_3D_Manager.DefaultShader.Bind();
	PolyHedra_3D_Manager.DefaultShader.DisplaySize.Put(WindowSize);
}
...
int Main()
{
	...
	window.MouseManager.Callback_ScrollEvent.Change(this, &MainContext::CursorScroll);
