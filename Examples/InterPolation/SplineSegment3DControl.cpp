	...
	Object(NULL)
{
	...
	T_Slider.ValueMin = -2.0f;
	C_Slider.ValueMin = -2.0f;
	B_Slider.ValueMin = -2.0f;

	T_Slider.ValueMax = +2.0f;
	C_Slider.ValueMax = +2.0f;
	B_Slider.ValueMax = +2.0f;

	T_Slider.ValueResolution = 0.1f;
	C_Slider.ValueResolution = 0.1f;
	B_Slider.ValueResolution = 0.1f;
