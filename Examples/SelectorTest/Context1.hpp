...
struct TestMenu1 : public UI::Control::Form
{
		...
		, Context1Button()
	{
		...
		QuitButton.ClickFunc.Assign(this, &TestMenu1::QuitFunc);
		...
		Context0Button.ClickFunc.Assign(this, &TestMenu1::Context0Func);
		...
		Context1Button.ClickFunc.Assign(this, &TestMenu1::Context1Func);
