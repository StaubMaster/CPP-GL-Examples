...
Physics2D::PolyGonContactData Physics2D::PolyGonContactData::Check(
	const Object & obj0,
	const Object & obj1,
	Point2D normal
)
...
*/
	...
	{
		Point2D pos0 = obj0.TransCorner(obj0.PolyGon() -> Sides[i].Corner0.Udx);
		Point2D pos1 = obj0.TransCorner(obj0.PolyGon() -> Sides[i].Corner1.Udx);
		Point2D pos2 = obj0.TransCorner(obj0.PolyGon() -> Sides[i].Corner2.Udx);

		n = (pos1 - pos0).perpendicular0();
		temp = Check(obj0, obj1, n);
	...
	{
		Point2D pos0 = obj1.TransCorner(obj1.PolyGon() -> Sides[i].Corner0.Udx);
		Point2D pos1 = obj1.TransCorner(obj1.PolyGon() -> Sides[i].Corner1.Udx);
		Point2D pos2 = obj1.TransCorner(obj1.PolyGon() -> Sides[i].Corner2.Udx);
